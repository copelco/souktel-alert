...
admin.site.register(SurveyAnswerE)
admin.site.register(SurveyAnswerM)
admin.site.register(SurveyCurrent)
admin.site.register(SurveyMask)
admin.site.register(SurveyMembers)
admin.site.register(SurveyOption)
admin.site.register(SurveyOptionTitle)
